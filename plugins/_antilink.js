...
export async function before(m, {conn, isAdmin, isBotAdmin}) {
  ...
  if (isAdmin && chat.antiLink && m.text.includes(grupo)) return m.reply('*𝐄𝐋 𝐀𝐍𝐓𝐈𝐋𝐈𝐍𝐊 𝐄𝐒𝐓𝐀 𝐀𝐂𝐓𝐈𝐕𝐎!! 𝐆𝐎𝐎𝐃 𝐄𝐑𝐄𝐒 𝐀𝐃𝐌𝐈𝐍!!*');
  if (chat.antiLink && isGroupLink && !isAdmin) {
    if (isBotAdmin) {
      const linkThisGroup = `https://chat.whatsapp.com/${await this.groupInviteCode(m.chat)}`;
      if (m.text.includes(linkThisGroup)) return !0;
    }
    await this.sendMessage(m.chat, {text: `* 𝐀𝐍𝐓𝐈 𝐋𝐈𝐍𝐊 *\n*𝐍𝐎 𝐃𝐄𝐁𝐈𝐒𝐓𝐄!! 👋 ${user} 𝐑𝐎𝐌𝐏𝐈𝐒𝐓𝐄 𝐋𝐀𝐒 𝐑𝐄𝐆𝐋𝐀𝐒 , 𝐂𝐇𝐀𝐎! 𝐏𝐎𝐑 𝐒𝐀𝐏𝐎!*`, mentions: [m.sender]}, {quoted: m});
